...
/**
 * The Abstract Class VTDXml Collection Handler.
 * <p>All VTDXmlCollectionHandler should extend this class.</p>
 *
...
public abstract class AbstractVTDXmlCollectionHandler extends AbstractXmlCollectionHandler {
     ...
     * @throws XPathParseException the x path parse exception
     * @throws XPathEvalException the x path eval exception
